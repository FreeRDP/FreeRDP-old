            ...
            char* mod, int mod_len, char* exp, int exp_len)
{
  ...
  l_out = (char*)l_malloc(max_size, 1);
  l_in = (char*)l_malloc(max_size, 1);
  l_mod = (char*)l_malloc(max_size, 1);
  l_exp = (char*)l_malloc(max_size, 1);
