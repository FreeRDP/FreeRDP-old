...
#ifndef	_AttachUserConfirm_H_
#define	_AttachUserConfirm_H_
...
/* AttachUserConfirm */
typedef struct AttachUserConfirm {
	Result_t	 result;
	UserId_t	*initiator	/* OPTIONAL */;
	struct AttachUserConfirm__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_AttachUserConfirm;
