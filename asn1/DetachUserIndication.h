...
#ifndef	_DetachUserIndication_H_
#define	_DetachUserIndication_H_
...
typedef struct DetachUserIndication {
	Reason_t	 reason;
	struct DetachUserIndication__userIds {
		A_SET_OF(UserId_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} userIds;
	struct DetachUserIndication__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} DetachUserIndication_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_DetachUserIndication;
...
#endif	/* _DetachUserIndication_H_ */
