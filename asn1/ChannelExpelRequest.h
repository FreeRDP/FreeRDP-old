...
#ifndef	_ChannelExpelRequest_H_
#define	_ChannelExpelRequest_H_
...
/* ChannelExpelRequest */
typedef struct ChannelExpelRequest {
	UserId_t	 initiator;
	PrivateChannelId_t	 channelId;
	struct ChannelExpelRequest__userIds {
		A_SET_OF(UserId_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} userIds;
	struct ChannelExpelRequest__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ChannelExpelRequest_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ChannelExpelRequest;
