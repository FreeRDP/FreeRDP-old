...
#ifndef	_TokenTestRequest_H_
#define	_TokenTestRequest_H_
...
/* TokenTestRequest */
typedef struct TokenTestRequest {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	struct TokenTestRequest__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenTestRequest;
