...
#ifndef	_ChannelDisbandRequest_H_
#define	_ChannelDisbandRequest_H_
...
typedef struct ChannelDisbandRequest {
	UserId_t	 initiator;
	PrivateChannelId_t	 channelId;
	struct ChannelDisbandRequest__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ChannelDisbandRequest_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ChannelDisbandRequest;
...
#endif	/* _ChannelDisbandRequest_H_ */
