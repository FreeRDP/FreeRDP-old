...
#ifndef	_TokenGrabConfirm_H_
#define	_TokenGrabConfirm_H_
...
/* TokenGrabConfirm */
typedef struct TokenGrabConfirm {
	Result_t	 result;
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	TokenStatus_t	 tokenStatus;
	struct TokenGrabConfirm__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenGrabConfirm;
