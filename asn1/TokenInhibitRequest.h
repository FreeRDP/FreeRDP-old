...
#ifndef	_TokenInhibitRequest_H_
#define	_TokenInhibitRequest_H_
...
/* TokenInhibitRequest */
typedef struct TokenInhibitRequest {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	struct TokenInhibitRequest__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TokenInhibitRequest_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenInhibitRequest;
