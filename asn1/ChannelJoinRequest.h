...
#ifndef	_ChannelJoinRequest_H_
#define	_ChannelJoinRequest_H_
...
/* ChannelJoinRequest */
typedef struct ChannelJoinRequest {
	UserId_t	 initiator;
	ChannelId_t	 channelId;
	struct ChannelJoinRequest__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ChannelJoinRequest_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ChannelJoinRequest;
