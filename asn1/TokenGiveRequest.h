...
#ifndef	_TokenGiveRequest_H_
#define	_TokenGiveRequest_H_
...
/* TokenGiveRequest */
typedef struct TokenGiveRequest {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	UserId_t	 recipient;
	struct TokenGiveRequest__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenGiveRequest;
