...
#ifndef	_TokenGiveIndication_H_
#define	_TokenGiveIndication_H_
...
/* TokenGiveIndication */
typedef struct TokenGiveIndication {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	UserId_t	 recipient;
	struct TokenGiveIndication__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TokenGiveIndication_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenGiveIndication;
