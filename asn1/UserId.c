...
int
UserId_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
UserId_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
UserId_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	UserId_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
UserId_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
UserId_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UserId_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
UserId_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UserId_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
UserId_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UserId_encode_uper(asn_TYPE_descriptor_t *td,
...
static ber_tlv_tag_t asn_DEF_UserId_tags_1[] = {
