...
#ifndef	_TokenTestConfirm_H_
#define	_TokenTestConfirm_H_
...
/* TokenTestConfirm */
typedef struct TokenTestConfirm {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	TokenStatus_t	 tokenStatus;
	struct TokenTestConfirm__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenTestConfirm;
