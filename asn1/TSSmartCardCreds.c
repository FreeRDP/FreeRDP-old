...
static int asn_MAP_TSSmartCardCreds_oms_1[] = { 2, 3 };
static ber_tlv_tag_t asn_DEF_TSSmartCardCreds_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TSSmartCardCreds_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pin at 31 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cspData at 32 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* userHint at 33 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* domainHint at 34 */
};
static asn_SEQUENCE_specifics_t asn_SPC_TSSmartCardCreds_specs_1 = {
	...
	asn_MAP_TSSmartCardCreds_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
