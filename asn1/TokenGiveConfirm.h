...
#ifndef	_TokenGiveConfirm_H_
#define	_TokenGiveConfirm_H_
...
/* TokenGiveConfirm */
typedef struct TokenGiveConfirm {
	Result_t	 result;
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	TokenStatus_t	 tokenStatus;
	struct TokenGiveConfirm__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenGiveConfirm;
