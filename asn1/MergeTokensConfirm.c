...
static asn_SET_OF_specifics_t asn_SPC_mergeTokens_specs_2 = {
	sizeof(struct MergeTokensConfirm__mergeTokens),
	offsetof(struct MergeTokensConfirm__mergeTokens, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_purgeTokenIds_specs_4 = {
	sizeof(struct MergeTokensConfirm__purgeTokenIds),
	offsetof(struct MergeTokensConfirm__purgeTokenIds, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_nonStandard_specs_6 = {
	sizeof(struct MergeTokensConfirm__nonStandard),
	offsetof(struct MergeTokensConfirm__nonStandard, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_MergeTokensConfirm_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MergeTokensConfirm, mergeTokens),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MergeTokensConfirm, purgeTokenIds),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct MergeTokensConfirm, nonStandard),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static int asn_MAP_MergeTokensConfirm_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_MergeTokensConfirm_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MergeTokensConfirm_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mergeTokens at 234 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* purgeTokenIds at 235 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonStandard at 236 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MergeTokensConfirm_specs_1 = {
	sizeof(struct MergeTokensConfirm),
	offsetof(struct MergeTokensConfirm, _asn_ctx),
	asn_MAP_MergeTokensConfirm_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_MergeTokensConfirm_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	2,	/* Start extensions */
	4	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_MergeTokensConfirm = {
	"MergeTokensConfirm",
	"MergeTokensConfirm",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_MergeTokensConfirm_tags_1,
	sizeof(asn_DEF_MergeTokensConfirm_tags_1)
		/sizeof(asn_DEF_MergeTokensConfirm_tags_1[0]), /* 1 */
	asn_DEF_MergeTokensConfirm_tags_1,	/* Same as above */
	sizeof(asn_DEF_MergeTokensConfirm_tags_1)
		/sizeof(asn_DEF_MergeTokensConfirm_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_MergeTokensConfirm_1,
	3,	/* Elements count */
	&asn_SPC_MergeTokensConfirm_specs_1	/* Additional specs */
};
