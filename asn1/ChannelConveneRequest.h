...
#ifndef	_ChannelConveneRequest_H_
#define	_ChannelConveneRequest_H_
...
typedef struct ChannelConveneRequest {
	UserId_t	 initiator;
	struct ChannelConveneRequest__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ChannelConveneRequest_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ChannelConveneRequest;
...
#endif	/* _ChannelConveneRequest_H_ */
