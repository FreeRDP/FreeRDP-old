...
#ifndef	_TokenPleaseRequest_H_
#define	_TokenPleaseRequest_H_
...
/* TokenPleaseRequest */
typedef struct TokenPleaseRequest {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	struct TokenPleaseRequest__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TokenPleaseRequest_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenPleaseRequest;
