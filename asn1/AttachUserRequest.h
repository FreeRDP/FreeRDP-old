...
#ifndef	_AttachUserRequest_H_
#define	_AttachUserRequest_H_
...
/* AttachUserRequest */
typedef struct AttachUserRequest {
	struct AttachUserRequest__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_AttachUserRequest;
