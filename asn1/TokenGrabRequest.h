...
#ifndef	_TokenGrabRequest_H_
#define	_TokenGrabRequest_H_
...
/* TokenGrabRequest */
typedef struct TokenGrabRequest {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	struct TokenGrabRequest__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenGrabRequest;
