...
#ifndef	_TokenPleaseIndication_H_
#define	_TokenPleaseIndication_H_
...
typedef struct TokenPleaseIndication {
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	struct TokenPleaseIndication__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TokenPleaseIndication_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenPleaseIndication;
...
#endif	/* _TokenPleaseIndication_H_ */
