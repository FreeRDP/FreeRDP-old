...
#ifndef	_TokenGiveResponse_H_
#define	_TokenGiveResponse_H_
...
/* TokenGiveResponse */
typedef struct TokenGiveResponse {
	Result_t	 result;
	UserId_t	 recipient;
	TokenId_t	 tokenId;
	struct TokenGiveResponse__nonStandard {
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenGiveResponse;
