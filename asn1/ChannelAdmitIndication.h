...
#ifndef	_ChannelAdmitIndication_H_
#define	_ChannelAdmitIndication_H_
...
typedef struct ChannelAdmitIndication {
	UserId_t	 initiator;
	PrivateChannelId_t	 channelId;
	struct ChannelAdmitIndication__userIds {
		A_SET_OF(UserId_t) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} userIds;
	struct ChannelAdmitIndication__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ChannelAdmitIndication_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ChannelAdmitIndication;
...
#endif	/* _ChannelAdmitIndication_H_ */
