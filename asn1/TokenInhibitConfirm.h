...
#ifndef	_TokenInhibitConfirm_H_
#define	_TokenInhibitConfirm_H_
...
/* TokenInhibitConfirm */
typedef struct TokenInhibitConfirm {
	Result_t	 result;
	UserId_t	 initiator;
	TokenId_t	 tokenId;
	TokenStatus_t	 tokenStatus;
	struct TokenInhibitConfirm__nonStandard {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TokenInhibitConfirm_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TokenInhibitConfirm;
