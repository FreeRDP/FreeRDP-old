...
void test_BitBlt_32bpp(void)
{
	...
	data = (uint8*) gdi_image_convert((uint8*) bmp_SRC, 16, 16, 8, bitsPerPixel, NULL);
	hBmpSrc = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_DST, 16, 16, 8, bitsPerPixel, NULL);
	hBmpDst = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_DST, 16, 16, 8, bitsPerPixel, NULL);
	hBmpDstOriginal = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_PAT, 8, 8, 8, bitsPerPixel, NULL);
