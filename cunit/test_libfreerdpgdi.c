...
void test_BitBlt_32bpp(void)
{
	...
	data = (uint8*) gdi_image_convert((uint8*) bmp_BLACKNESS, 16, 8, 16, bitsPerPixel, hPalette);
	hBmp_BLACKNESS = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_WHITENESS, 16, 8, 16, bitsPerPixel, hPalette);
	...
	data = (uint8*) gdi_image_convert((uint8*) bmp_MERGECOPY, 16, 16, 16, bitsPerPixel, hPalette);
	hBmp_MERGECOPY = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_MERGEPAINT, 16, 16, 16, bitsPerPixel, hPalette);
	hBmp_MERGEPAINT = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_PATCOPY, 16, 16, 16, bitsPerPixel, hPalette);
	hBmp_PATCOPY = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_PATPAINT, 16, 16, 16, bitsPerPixel, hPalette);
	hBmp_PATPAINT = CreateBitmap(16, 16, bitsPerPixel, data);

	data = (uint8*) gdi_image_convert((uint8*) bmp_PATINVERT, 16, 16, 16, bitsPerPixel, hPalette);
